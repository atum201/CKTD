...
namespace Coinbase
{
   ...
   public class CoinbaseApi
   {
         ...
         WebProxy proxy = null)
      {
         ...
         //}
         if( string.IsNullOrWhiteSpace(apiKey) ) throw new ArgumentException("The API key must be specified.", "apiKey");
         if( string.IsNullOrWhiteSpace(apiSecret) ) throw new ArgumentException("The API secret must be specified.", "apiSecret");
      ...
      {
         string id = checkoutResponse.Data["id"]==null?"":checkoutResponse.Data["id"].ToString();
         if( string.IsNullOrWhiteSpace(id) )
            throw new ArgumentException("The checkout response must have an ID field. None was found.", "checkoutResponse");
