<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Backend/QuanTri/QuanTri.master" AutoEventWireup="true" CodeFile="TaoMoiTinTuc.aspx.cs" Inherits="Views_Backend_QuanTri_QuanLyTinTuc_TaoMoiTinTuc" %>
             ...
             <div class="formInner">
                ...
                <div class="formFooter columns is-alignCenter">
                    <div class="column continue">
                        ...
                        <asp:Button runat="server" ID="btnLuu" CssClass="subfrm button continue" Text="Lưu lại" OnClick="btnLuu_Click" />
