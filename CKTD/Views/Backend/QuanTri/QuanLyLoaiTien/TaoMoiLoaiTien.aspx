<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Backend/QuanTri/QuanTri.master" AutoEventWireup="true" CodeFile="TaoMoiLoaiTien.aspx.cs" Inherits="Views_Backend_QuanTri_QuanLyLoaiTien_TaoMoiLoaiTien" %>
        ...
        <div id="buyCoin" class="tab-content is-active">
            ...
            <div class="formInner">
                ...
                <div class="field is-horizontal is-alignCenter">
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control">
                                <asp:FileUpload ID="filelinkicon" AllowMultiple="false" runat="server" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="formFooter columns is-alignCenter">
                <div class="column continue">
                    ...
                    <asp:Button runat="server" ID="btnLuu" CssClass="subfrm button continue" Text="Lưu lại" OnClientClick="return Validate()" OnClick="btnLuu_Click" />
