<%@ Page Language="C#" MasterPageFile="~/QuanTri/QuanTri.master" AutoEventWireup="true" CodeFile="DV_DichVuCongBac4.aspx.cs" Inherits="QuanTri_DV_DichVuCongBac4" %>
...
<asp:Content ID="ContentRightColumn" ContentPlaceHolderID="cphRightColumn" Runat="Server">
    <b>Danh sách Dịch vụ công bậc 4 - Đơn vị chủ quản</b>
    <table class="table">
        <thead>
            <tr>
                <th>Tên dịch vụ</th>
